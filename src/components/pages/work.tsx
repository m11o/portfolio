              ...
              {this.state.works.map((work: EntryFields.Object) => {
                ...
                return (
                  <LinkBox key={name} as='article' borderWidth='3px' rounded='md' h='auto' maxH={{ base: '400px', md: '500px' }} w={{ base: '100%', md: '45%' }} mb={{ base: 5, md: 0 }}>
                    <Image borderBottomWidth='2px' src={thumbnail && thumbnail.sys.id ? (this.state.thumbnailLinks[thumbnail.sys.id]) : PortfolioIcon} borderTopRadius='md' h='50%' w='100%' fit='fill' />
                    <Box p={4}>
